          ...
          <div class="col-lg-12">
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="product-thumbs text-left">
                  <carousel
